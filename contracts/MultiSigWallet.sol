...
contract MultiSigWallet {
    ...
    */
    ...
    function createTrans(address _to, uint256 _amount) external onlyOwner {
        ...
        // use for send ETH to wallet
        // transAmount is equal to total amount of all pending transactionID
        require(
    ...
    /* ----- CONSENSUS ----- */
    // create consensus
    //calldata is cheaper than memory, but only for external function, not modifier
    // only address wallet create multisig wallet can call this function
    function createCons(
